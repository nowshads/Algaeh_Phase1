              ...
              >
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <TextFieldData hintText="BILL NO." />
                    </td>
                    <td>
                      <SelectFieldDrop
                        children={FORMAT_DEFAULT}
                    ...
                    <td>
                      <TextFieldData hintText="CONSULT FEE" />
                    </td>
                    <td>
                      <TextFieldData hintText="ADV. FEE" />
                    </td>
                    <td>
                      <TextFieldData hintText="DISCOUNT" />
                    </td>
                    <td>
                      <TextFieldData hintText="TOTAL AMT." disabled={true} />
                    </td>
                  </tr>
                </tbody>
